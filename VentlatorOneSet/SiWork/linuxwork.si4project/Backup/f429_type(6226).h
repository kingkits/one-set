...
typedef unsigned short int uint16_t; /* defined for unsigned 16-bits integer variable     无符号16位整型变量       */
typedef signed short int   int16_t;  /* defined for signed 16-bits integer variable       有符号16位整型变量                  */
