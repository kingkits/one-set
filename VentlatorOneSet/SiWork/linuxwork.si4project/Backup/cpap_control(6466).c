...
void cpap_caculate_c_flex_blower_speed(uint16_t set_speed)
{
    ...
    cpap_control_dat.c_flex_speed = (4 - main_control_data.c_flex_level) * speed;
    ...
    case 0:
        ...
        break;
    case 1:
        cpap_control_dat.c_flex_speed = old_speed - speed;
        break;
    case 2:
        cpap_control_dat.c_flex_speed = old_speed - speed - speed;
        break;
    case 3:
        cpap_control_dat.c_flex_speed = old_speed - speed - speed - speed;
        break;
    case 4:
        cpap_control_dat.c_flex_speed = old_speed - speed - speed - speed - speed;
        break;
    }
...
/**
 * [correct_cpap_peep description]
 * @method correct_cpap_peep
 */
// 不考虑压力的影响，只考虑泄漏漏量及PeeP阀的流量
void correct_cpap_peep(void)
{
    // 在大泄露量的情况下，要考虑减小PEEP阀的开度，为保障安全，应该强制给一个最小的安全开度
...
CORRECT_CPAP_SPEED_NEXT3:
    // step 4
    // 纠正不规范的调整数据
    if(cpap_control_dat.exhale_speed < MIN_BLOWER_SPEED)
        cpap_control_dat.exhale_speed = MIN_BLOWER_SPEED;
    // correct c-flex
