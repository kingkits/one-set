...
extern uint32_t expire_sensor_flow_data[];
...
extern uint32_t sensor_oxygen_flow_data[];
...
{
    init_insert_data(&expire_low_flow_data,  18, expire_sensor_flow_data,   expire_flow_val_data, ENUM_DATA_IS_INCREASE);
...
{
    init_insert_data(&Oxygen_flow_data, 16, sensor_oxygen_flow_data, Oxygen_flow_val_data, ENUM_DATA_IS_INCREASE);
}
