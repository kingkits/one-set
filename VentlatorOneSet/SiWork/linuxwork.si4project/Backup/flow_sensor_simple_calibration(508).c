...
uint8_t append_simple_calibration_flow_sum_data(void)
{
    ...
    {
        Calibration_flow_sensor_adc_data[simple_calibration_flow_work_data.count] = simple_calibration_flow_work_data.sensor_low_sum / simple_calibration_flow_work_data.sum_count;
        Calibration_flow_sensor_adc_hdata[simple_calibration_flow_work_data.count] = simple_calibration_flow_work_data.sensor_high_sum / simple_calibration_flow_work_data.sum_count;
        Calibration_flow_data[simple_calibration_flow_work_data.count] = simple_calibration_flow_work_data.flow_sum / simple_calibration_flow_work_data.sum_count;
