...
void init_peep_test_data(void)
{
    ...
    peep_test_data.current_press_locate =     0;
    peep_test_data.peep_target_flow     = 10000;
    peep_test_data.peep_target_press    =   100;
    peep_test_data.set_peep_val         =  1000;
    peep_test_data.start_flow_locate    =     0;
    peep_test_data.start_press_locate   =     0;
    peep_test_data.stop_flow_locate     =     0;
    peep_test_data.stop_press_locate    =     0;
...
uint8_t peep_test_adjust_flow(void)
{
    ...
    // get flow
    flow = (int32_t)get_inspire_flow();

    if(peep_test_data.peep_target_flow < 5000) peep_test_data.peep_target_flow = 5000;
    // count different
