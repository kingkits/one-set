...
typedef enum
{
    ...
    BASE_sensor_oxygen_DATA_MSG  = 0x2F,//读取氧传感器校准值   0x2F
...
#define is_calibration_sensor_oxygen_data_set_complete() (st_ui_send_message_flag.oxygen_set_data_ack == 1)
...
void trans_calibration_flow_sensor_upload_data(void)
{
    ...
    packed_commnication_data((uint8_t *)ptr, len);
}
