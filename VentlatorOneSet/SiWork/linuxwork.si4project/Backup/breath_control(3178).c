...
// 代码开始
/**
 * [copy_control_data description]
 * @method copy_control_data
 * @param  src               [description]
 * @param  tar               [description]
 */
...
/**
 * [set_ui_change_parameters description]
...
/**
 * [is_ui_change_parameters description]
...
// 不进行合法性检测，需要调用者自己确认
/**
 * [set_patient_breath_mode description]
...
/**
 * [get_patient_breath_mode description]
...
/**
 * [set_PID_blower_control_status description]
...
/**
 * [get_main_control_status description]
...
/**
 * [get_press_increase description]
...
/**
 * [set_main_control_epap_data description]
 * @method set_main_control_epap_data
 * @param  epap                       [description]
 */
...
/**
 * [is_epap_gate_ready description]
 * @method is_epap_gate_ready
 * @param  delta_p            [description]
 * @return                    [description]
 */
...
/**
 * [reset_main_control_data description]
...
/**
 * [set_changemode_actived_mode description]
...
/**
 * [set_cough_stop_mode description]
...
#if USE_BREATH_CYCLES_ADJUST
/**
 * [breath_cycle_adjust_set_ipap description]
 * @method breath_cycle_adjust_set_ipap
 * @return                              [description]
 */
void breath_cycle_adjust_set_ipap(void)
{
 ...
 */
void breath_cycle_adjust_set_epap(void)
{
 ...
 */
void breath_cycle_adjust_set_T_press(void)
{
 ...
 */
void breath_cycles_adjust_work(void)
{
 ...
 */
void breath_ST_adjust_speed(void)
{
    uint32_t speed;
    if(PID_blower_control_data.T_High_speed < PID_blower_control_data.Low_speed)
    {
 ...
 */
void PCV_set_speed_T_press(void)
{
 ...
 */
void breath_pcv_adjust_speed(void)
{
    uint32_t speed;
    if(PID_blower_control_data.T_High_speed < PID_blower_control_data.Low_speed)
    {
