...
void refresh_stv_inhale_press_low(int16_t press, int32_t flow)
{
    ...
    if(stv_control_dat.inhale_press_low == CPAP_PRESS_DEFAULT_SET_VALUE)
    {
...
void refresh_stv_exhale_press_high(int16_t press, int32_t flow)
{
    ...
    if(stv_control_dat.exhale_press_high == CPAP_PRESS_DEFAULT_SET_VALUE)
    {
...
void breath_stv_mode(void)
{
    ...
    case EM_PATIENT_EXHALE_DETECT:	// 监测呼气触发条件
        ...
        refresh_stv_inhale_press_low(display_count_data.Press, display_count_data.Flow);
    ...
    case EM_PATIENT_EXHALE_PERIOD:
        ...
        refresh_stv_exhale_press_high(display_count_data.Press, display_count_data.Flow);
