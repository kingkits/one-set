...
#if USE_SYSTEM_TIMER_COMPARE_FUNCTION
        return(system_direct_compare_tm1_be_tm2(ms_1_count, breath_rap_control_data.time_stamp + breath_rap_control_data.inspire_work_time));
#else
        if(ms_1_count - breath_rap_control_data.time_stamp > breath_rap_control_data.inspire_work_time)// TDB
        {
            return EM_TRUE;
        }
        else return EM_FALSE;
...
void test_rap(void)
{
    ...
    breath_rap_control_data.inspire_work_time = 3000;
