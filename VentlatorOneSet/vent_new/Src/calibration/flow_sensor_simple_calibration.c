...
#define MAX_SIMPLE_CLIBRATION_FLOW_WORK_NUM 128
...
CCMRAM uint16_t Calibration_flow_tsi_V_data[MAX_SIMPLE_CLIBRATION_FLOW_WORK_NUM];
CCMRAM uint16_t Calibration_flow_tsi_T_data[MAX_SIMPLE_CLIBRATION_FLOW_WORK_NUM];

CCMRAM int32_t Calibration_flow_data[MAX_SIMPLE_CLIBRATION_FLOW_WORK_NUM];
CCMRAM int32_t Calibration_flow_data_real[MAX_SIMPLE_CLIBRATION_FLOW_WORK_NUM];
...
/**
 * [reset_simple_calibration_flow_sum_data description]
 * @method reset_simple_calibration_flow_sum_data
 */
...
/**
 * [append_simple_calibration_flow_sum_data description]
 * @method append_simple_calibration_flow_sum_data
 * @return                                         [description]
 */
uint8_t append_simple_calibration_flow_sum_data(void)
{
    ...
    {
        temp = simple_calibration_flow_work_data.sensor_low_sum / (uint32_t)simple_calibration_flow_work_data.sum_count;
        Calibration_flow_sensor_adc_data[simple_calibration_flow_work_data.count] = (uint16_t) (temp & 0xffff);
        temp = simple_calibration_flow_work_data.sensor_high_sum / (uint32_t)simple_calibration_flow_work_data.sum_count;
        Calibration_flow_sensor_adc_hdata[simple_calibration_flow_work_data.count] = (uint16_t) (temp & 0xffff);
        temp = simple_calibration_flow_work_data.flow_sum / (uint32_t)simple_calibration_flow_work_data.sum_count;
        Calibration_flow_data[simple_calibration_flow_work_data.count] = temp ;
        temp = simple_calibration_flow_work_data.real_sum / (uint32_t)simple_calibration_flow_work_data.sum_count;
        Calibration_flow_data_real[simple_calibration_flow_work_data.count] = temp ;

        temp = simple_calibration_flow_work_data.tsiV_sum / (uint32_t)simple_calibration_flow_work_data.sum_count;
        Calibration_flow_tsi_V_data[simple_calibration_flow_work_data.count] = (uint16_t) (temp & 0xffff);
        temp = simple_calibration_flow_work_data.tsiT_sum / (uint32_t)simple_calibration_flow_work_data.sum_count;
        Calibration_flow_tsi_T_data[simple_calibration_flow_work_data.count] = (uint16_t) (temp & 0xffff);
...
/**
 * [reset_simple_calibration_flow_data description]
 * @method reset_simple_calibration_flow_data
 */
...
/**
 * [simple_calibration_flow_start description]
 * @method simple_calibration_flow_start
 */
...
/**
 * [simple_calibration_flow_increase description]
 * @method simple_calibration_flow_increase
 */
...
/**
 * [do_simple_calibration_flow_work description]
 * @method do_simple_calibration_flow_work
 */
