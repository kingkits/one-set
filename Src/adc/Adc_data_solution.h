...
#define MIN_EEPROM_LIST_DATA_NUM 5
...
extern unsigned int exhale_flow_val_data[],      exhale_flow_sensor_data[];
extern unsigned int exhale_flow_high_idx_data[], exhale_flow_high_data[];
